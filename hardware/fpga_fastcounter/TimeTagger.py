...
class TimeTagger:
    ...
    def setTestSignal(self, channel, enabled):
        """setTestSignal(self, channel, enabled)"""
        return _TimeTagger.TimeTagger_setTestSignal(self, channel, enabled)
...
class Dump(_Iterator):
    ...
    def __init__(self, tagger, filename, max_tags=1000000):
        """
        __init__(self, tagger, filename, max_tags=1000000) -> Dump
        __init__(self, tagger, filename) -> Dump
        """
        this = _TimeTagger.new_Dump(tagger, filename, max_tags)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
